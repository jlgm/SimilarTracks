angular.module('trackApp', [])
  .controller('TrackListController', ['$scope','$http', function($scope,$http) {
    ...
    trackList.getTracks = function() {
        $http.get("https://ws.audioscrobbler.com/2.0/?method=track.getsimilar&artist=" + trackList.artist + "&track=" + trackList.track + "&api_key=ed77b11b1f0965db65c3144cbffaf27b&format=json").then(function(response) {
